...
usc = Campus.create(school_name: "USC", org_name: "USC ICA", keywords: "USC, student organization, campus fellowship, fellowship, discipleship, evangelism, witnessing, navigators, missions, navs, ministry", description: "USC In Christ Alone (ICA) is a recognized student organization at USC that welcomes both believers and non-believers. We have a strong emphasis on discipleship and seeking and saving the lost. Our desire is to know Christ and make Christ known on our campus and around the world. We hold weekly small group Bible studies and large group meetings along with other fun activities.", rally_name: "Large Group Rally", rally_datetime: "Thursday, 6:30pm (starting 8/31)", rally_location: "GFS 101", church_name: "Church", church_datetime: "Sunday Service begins at 9:45am", church_location: "SGM 101", announcements_bg_color1_class: "bg-gold", announcements_bg_color2_class: "bg-red", fb_campus_link: "https://www.facebook.com/groups/5748715849/?ref=br_tf", fb_link_class: "usc-link", gcal_path: "https://www.google.com/calendar/embed?src=uscinchristalone%40gmail.com&ctz=America/Los_Angeles", url_key: "usc", email: USC_EMAIL)
