...
usc = Campus.create(school_name: "USC", org_name: "USC ICA", keywords: "USC, student organization, campus fellowship, fellowship, discipleship, evangelism, witnessing, navigators, missions, navs, ministry", description: "USC In Christ Alone (ICA) is a recognized student organization at USC that welcomes both believers and non-believers. We have a strong emphasis on discipleship and seeking and saving the lost. Our desire is to know Christ and make Christ known on our campus and around the world. We hold weekly small group Bible studies and large group meetings along with other fun activities.", rally_name: "Large Group Rally", rally_datetime: "Thursday, 6:30pm", rally_location: "KAP 163 (THH 210 starting 9/12)", church_name: "Church", church_datetime: "Sunday Service begins at 9:45am", church_location: "SGM 101", announcements_bg_color1_class: "bg-gold", announcements_bg_color2_class: "bg-red", fb_campus_link: "https://www.facebook.com/groups/5748715849/?ref=br_tf", fb_link_class: "usc-link", gcal_path: "https://www.google.com/calendar/embed?src=uscinchristalone%40gmail.com&ctz=America/Los_Angeles", url_key: "usc", email: USC_EMAIL)

ucla = Campus.create(school_name: "UCLA", org_name: "Bruin ICA", keywords: "UCLA, student organization, campus fellowship, fellowship, discipleship, evangelism, witnessing, navigators, missions, navs, ministry", description: "Brothers and sisters committed to worshipping Christ and making Him known.", rally_name: "Large Group Rally", rally_datetime: "Wednesday, 6:30pm", rally_location: "Bunche 3143", church_name: "Church", church_datetime: "Pickup time: 9:00am", church_location: "Pickup location: De Neve Turnaround", announcements_bg_color1_class: "bg-gold", announcements_bg_color2_class: "bg-ucla-blue", fb_campus_link: "https://www.facebook.com/groups/5175699521/", fb_link_class: "usc-link", gcal_path: "https://www.google.com/calendar/embed?src=icabruins%40gmail.com&ctz=America/Los_Angeles", url_key: "ucla", email: UCLA_EMAIL)

uci = Campus.create(school_name: "UCI", org_name: "Irvine ICA", keywords: "UCI, student organization, campus fellowship, fellowship, discipleship, evangelism, witnessing, navigators, missions, navs, ministry", description: "Brothers and sisters committed to worshipping Christ and making Him known.", rally_name: "Large Group Rally", rally_datetime: "Thursday, 6:30pm", rally_location: "Social Science Tower 238", church_name: "Church", church_datetime: "Pickup time: 8:45am", church_location: "Pickup location: Please contact driver", announcements_bg_color1_class: "bg-gold", announcements_bg_color2_class: "bg-ucla-blue", fb_campus_link: "https://www.facebook.com/groups/28628738058/", fb_link_class: "usc-link", gcal_path: "https://www.google.com/calendar/embed?src=irvineica%40gmail.com&ctz=America/Los_Angeles", url_key: "uci", email: UCI_EMAIL)
...
{name: "Yvonne Li", title: "UCLA/USC Women's Ministry Leader", image_path: "leaders-yvonne", position: 3, bio: "Yvonne may be from a small town near San Francisco (Pacifica), but she has a huge heart for people everywhere, especially those who don't know Jesus. She's a true Bruin at heart, where she graduated with a biochemistry degree, but has since also started a masters in public health at USC (love your enemies)! Yvonne experienced the love and healing of Christ in her freshmen year at UCLA, and now spends most of her time on both campuses and overseas sharing the good news to those who haven't heard. She is a fierce, faithful, and fun discipler who is looking forward to raising up the next generation!", is_active: true},
{name: "Ethan Chan", title: "USC Men's Team Leader", image_path: "leaders-ethan", position: 4, bio: "An enthusiastic evangelist and loyal brother, Ethan's life was changed when he grew a love for quiet time and seeing God's love through His Word. He now leads the sophomore and junior small group, disciples younger men, and is working toward a progressive Master's degree in Electrical Engineering. Ethan hails from the beautiful state of Hawaii and enjoys playing the ukulele, playing tennis, experimenting in the kitchen, and watching his unsuspecting friends try his kitchen experiments.", is_active: true}
])
