class UciController < ApplicationController
  def home
    ...
    calendar_feed_addr = 'http://www.google.com/calendar/feeds/irvineica@gmail.com/public/full?orderby=starttime&sortorder=ascending&futureevents=true&singleevents=true'
